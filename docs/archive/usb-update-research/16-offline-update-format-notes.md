# [ARCHIVED] Tesla Offline USB Update Package Binary Format
...
**Superseded By:** [USB-OFFLINE-UPDATE-COMPLETE.md](../../core/USB-OFFLINE-UPDATE-COMPLETE.md)

---

This document represents detailed binary format analysis that was consolidated into the comprehensive package analysis. It is preserved here for research history.

**Key Contributions from This Document:**
- Binary signature structure (0xba01ba01 magic number)
- NaCl Ed25519 signature format details
- dm-verity hash table location and format
- Signature blob header structure
