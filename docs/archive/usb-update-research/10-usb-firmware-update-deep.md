# [ARCHIVED] MCU2 USB / Offline Firmware Update – Deep Dive (evidence-based)
...
**Superseded By:** [USB-OFFLINE-UPDATE-DEEP-DIVE.md](../../core/USB-OFFLINE-UPDATE-DEEP-DIVE.md)

---

This document represents detailed research into USB update mechanisms that was consolidated into the comprehensive analysis. It is preserved here for research history.

**Key Contributions from This Document:**
- Complete `/mnt/update` mountpoint analysis
- `usbupdate-server` service configuration details
- dm-verity mounting mechanism documentation
- Updater-envoy offline bank management analysis

For current information, see the superseding document above.

---

**Original Scope:** Determine whether MCU2 firmware can be installed "offline/from USB" via an intended (non-exploit) mechanism, and document concrete evidence of: mount points, expected file naming, gating checks (factory/fusing), and offline signature verification.
