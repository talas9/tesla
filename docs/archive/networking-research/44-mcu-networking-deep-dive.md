# [ARCHIVED] MCU2 Network Security Deep Dive

**Archive Date:** 2026-02-03  
**Archive Reason:** Content superseded by enhanced version  
**Superseded By:** [44-mcu-networking-enhanced.md](../../ape/44-mcu-networking-enhanced.md)

---

This document represents the original MCU2 networking analysis that was enhanced with additional findings. It is preserved here for research history.

**Key Contributions from This Document:**
- Initial service-to-binary mapping
- Original port inventory
- Preliminary attack surface analysis

For current information, see the enhanced version above.

---

**Complete networking analysis of Tesla MCU2 firmware**
**Original Source:** `/firmware/mcu2-extracted`
**Original Analysis Date:** 2025-02-03
