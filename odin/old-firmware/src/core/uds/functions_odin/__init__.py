...
# Embedded file name: /firmware/components/odin/src/odin/core/uds/functions_odin/__init__.py
...
from .upload_download import data_upload, transfer_data, request_data_upload, request_transfer_exit
...
def init_uds_interface():
    ...
    uds.transfer_data = transfer_data
    uds.request_data_upload = request_data_upload
    uds.request_transfer_exit = request_transfer_exit

# okay decompiling /root/downloads/old-firmware/opt/odin/odin_extracted/out00-PYZ.pyz_extracted/odin/core/uds/functions_odin/__init__.pyc
