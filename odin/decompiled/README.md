...
- **Source:** Extracted from `/opt/odin/` in old firmware
...
**Source:** `odin/old-firmware/src/`  
**Requirements:** `requirements.txt`  
**Documentation:** This README

## Related

- **Latest ODJ Files:** `odin/latest/data/`
- **Config Decoder Tool:** `scripts/decode_gateway_config.py`
- **ODJ Decryptor Tool:** `scripts/decrypt_odj.py`
